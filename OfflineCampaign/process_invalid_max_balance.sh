...
echo -e "and R.SEQ_NO = 1 and R.FIELD_NAME = 'MAX_BALANCE' and R.REMARK = 'Invalid MAX_BALANCE'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,FIELD_NAME=MAX_BALANCE,REMARK=Invalid MAX_BALANCE : ${COUNT}"
