...
select @template_code = 'PE_OFFLINE_CAMPAIGN'
, @run_date = '20160616'
, @file_name = 'CRM_R000001_20160616_001.csv'
, @loop = 1
...
begin
  ...
  begin
    ...
    delete PM_ADJUST_TRANSACTION_CREDIT_NOTE
    from PM_ADJUST_TRANSACTION_CREDIT_NOTE AC
    inner join PM_ADJUST_TRANSACTION T on (AC.ADJUST_ID = T.ADJUST_ID)
    ...
    delete PM_BATCH_CAMPAIGN
    from PM_BATCH_CAMPAIGN P
    inner join PM_PREPAID_LOAD_BATCH B on (P.BATCH_ID = B.BATCH_ID)
    where B.ORDER_ID = @order_id

    delete PM_INF_BATCH_CAMPAIGN
    from PM_INF_BATCH_CAMPAIGN I
