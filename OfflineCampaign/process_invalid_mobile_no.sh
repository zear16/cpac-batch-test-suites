...
echo -e "and R.SEQ_NO = 1 and R.FIELD_NAME = 'MOBILE_NO' and R.REMARK = 'Invalid MOBILE_NO'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,FIELD_NAME=MOBILE_NO,REMARK=Invalid MOBILE_NO : ${COUNT}"
