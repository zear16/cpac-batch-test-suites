...
echo -e "and R.SEQ_NO = 1 and R.FIELD_NAME = 'NEGATIVE_CODE' and R.REMARK = 'Invalid NEGATIVE_CODE'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,FIELD_NAME=NEGATIVE_CODE,REMARK=Invalid NEGATIVE_CODE : ${COUNT}"
