...
select @template_code = 'PE_OFFLINE_CAMPAIGN', @run_date = '20160616'
, @file_name = 'CRM_R000001_20160616_001.csv'
, @sync_name = 'CRM_R000001_20160616_001.end'
...
begin
  ...
  , '/export/home/MNT_NFS/campaign', @sync_name
  , 'BOS'
  , @version_id, @file_name, @file_name, '/export/home/MNT_NFS/campaign', 'W')
