...
echo "found PM_BATCH_CAMPAIGN : ${COUNT}"
...
echo -e "and T.BOS_ADJUST_FLAG = 1" >> ${SCRIPT}
echo -e "and T.BOS_MAX_FLAG = 0" >> ${SCRIPT}
echo -e "and T.BOS_RTNER = 1" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "      ,BOS_ADJUST_FLAG=1,BOS_MAX_FLAG=0,BOS_RTNER=1 : ${COUNT}"
