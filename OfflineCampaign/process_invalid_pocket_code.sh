...
echo -e "and R.SEQ_NO = 1 and R.FIELD_NAME = 'POCKET_CODE' and R.REMARK = 'Invalid POCKET_CODE'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,FIELD_NAME=POCKET_CODE,REMARK=Invalid POCKET_CODE : ${COUNT}"
