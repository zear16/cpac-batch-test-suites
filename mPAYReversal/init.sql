...
delete from PM_JOB_ORDER where VERSION_ID = @version_id and FILE_NAME = @file_name and RUN_DATE = @run_date
...
begin
  ...
  , @bank_code, @category_code, @company_id
  , @version_id, @file_name, @file_name, @file_name, '/app/payment/batch/mpay_settlement/DATA', 'W')
