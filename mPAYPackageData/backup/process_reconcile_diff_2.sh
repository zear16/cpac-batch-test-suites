...
echo -e "and D.PACKAGE_ID = 161617" >> ${SCRIPT}
...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with D_MOBILE_NO=0901000009,TRANS_DTM=20160616,PACKAGE_ID=161617,PACKAGE_FEE=1000 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with D_MOBILE_NO=0901000009,TRANS_DTM=20160616,PACKAGE_ID=161617,PACKAGE_FEE=100 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
