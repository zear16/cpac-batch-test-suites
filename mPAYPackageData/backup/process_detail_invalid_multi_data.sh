...
echo -e "and R.FIELD_NAME = 'COMPANY_ACCOUNT'" >> ${SCRIPT}
echo -e "and R.REMARK = 'Invalid COMPANY_ACCOUNT'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=2,FIELD_NAME=COMPANY_ACCOUNT,REMARK=Invalid COMPANY_ACCOUNT  : ${COUNT}"
...
echo -e "where B.ORDER_ID = ${ORDER_ID}" >> ${SCRIPT}
echo -e "and R.SEQ_NO = 2" >> ${SCRIPT}
echo -e "and R.FIELD_NAME = 'BANK_CODE'" >> ${SCRIPT}
echo -e "and R.REMARK = 'Invalid BANK_CODE'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=2,FIELD_NAME=BANK_CODE,REMARK=Invalid BANK_CODE : ${COUNT}"
