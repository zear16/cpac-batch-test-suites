...
select D.D_MOBILE_NO, D.FACE_VALUE, D.TRANS_DTM
...
and R.REF_2_AMT = 19.07
and R.REF_2_VALIDITY = 0
and R.REF_3_RECORD = 1
and R.REF_3_AMT = 3.07
...
echo "      ,REF_2_RECORD=2,REF_2_AMT=19.07,REF_2_VALIDITY=0"
