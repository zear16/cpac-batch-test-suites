...
select @template_code = 'PE_BILL_TOPUP_BOS'
, @run_date = '20160616'
, @file_name = 'GSM_BOS20160616.dat'

select @bos_id = BOS_ID from PM_CFG_BOS_SITE where FILE_TYPE = 'PE_BILL_TOPUP_BOS' and BOS_SITE_CODE = 'bos1/EXT_INTERFACE'
