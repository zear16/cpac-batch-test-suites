...
select @template_code = 'PE_ROM_PACKAGE_DATA'
, @run_date = '20160616'
, @file_name = 'DATA_ROM_BOS_20160616.dat'
...
begin
  ...
  , @bank_code, @category_code, @company_id
  , @version_id, @file_name, @file_name, null, '/opt/ais/cpac/batchprepaid/ROM_PKG_DATA', 'W')
