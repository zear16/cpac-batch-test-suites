...
begin
  ...
  (TEMPLATE_NAME, TEMPLATE_VERSION, PAPER_SIZE_ID
  , LANGUAGE_ID
  , ACTIVE_BOO, CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  ('Template Unit Test', '1.0', @paper_size_id
  , @language_id
...
values
(@company_id, @document_type_id, @template_id, 'Unit Test ROM Package Data', dateadd(dd, -1,@run_date), 'A', 1
