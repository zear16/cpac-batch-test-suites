...
echo -e "and D.PACKAGE_CODE = 160001" >> ${SCRIPT}
echo -e "and D.PACKAGE_FEE = 3.07" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with D_MOBILE_NO=0901000009,TRANS_DTM=20160615,PACKAGE_CODE=160001,PACKAGE_FEE=3.07 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
...
and D.D_MOBILE_NO = '0901000009'
and D.TRANS_DTM = '20160615'
and D.PACKAGE_CODE = 160001
and D.PACKAGE_FEE = 100
...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with D_MOBILE_NO=0901000009,TRANS_DTM=20160615,PACKAGE_CODE=160001,PACKAGE_FEE=100 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
