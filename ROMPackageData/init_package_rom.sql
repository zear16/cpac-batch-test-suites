...
begin
  ...
  values
  (160000, @package_name, 'V', 100, @bank_code
  , 'Y'
  , 'Y', @run_date
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160001, @package_name, 'D', 100, @bank_code
  , 'Y'
  , 'Y', @run_date
  , 'unit', getdate(), 'unit', getdate())
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160002, @package_name, 'V', 100, @bank_code
  , 'Y'
  , 'N', @run_date
  , 'unit', getdate(), 'unit', getdate())
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160003, @package_name, 'D', 100, @bank_code
  , 'Y'
  , 'N', @run_date
  , 'unit', getdate(), 'unit', getdate())
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160004, @package_name, 'V', 100, @bank_code
  , 'Y'
  , 'Y', @run_date
  , 'unit', getdate(), 'unit', getdate())
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160005, @package_name, 'D', 100, @bank_code
  , 'Y'
  , 'Y', @run_date
  , 'unit', getdate(), 'unit', getdate())
