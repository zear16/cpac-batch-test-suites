...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF_TABLE with RECONCILE_CODE=027,TABLE_NAME=PM_CREDIT_NOTE : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
...
echo -e "and R.REF_2_AMT = 34" >> ${SCRIPT}
...
echo -e "and R.REF_1_M_REF_2_AMT = 18" >> ${SCRIPT}
...
echo "      ,REF_2_RECORD=2,REF_2_AMT=34,REF_2_VALIDITY=0"
echo "      ,REF_1_L_REF_2_RECORD=0,REF_1_L_REF_2_AMT=0,REF_1_L_REF_2_VALIDITY=0"
echo "      ,REF_1_M_REF_2_RECORD=1,REF_1_M_REF_2_AMT=18,REF_1_M_REF_2_VALIDITY=0"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
