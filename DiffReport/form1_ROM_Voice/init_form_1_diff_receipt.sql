...
select @product_id = PACKAGE_CODE, @product_name = PACKAGE_NAME
     , @bank_code = BANK_CODE, @total_amt = PACKAGE_FEE
from PM_PACKAGE
where PACKAGE_CODE = 161601
