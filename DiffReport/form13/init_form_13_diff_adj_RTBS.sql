...
begin
  ...
  if (@i < 6 or @i = 13)
  begin
     select @receipt_date = @adjust_date
...
-- wrong number
  select @trans_no = convert(bigint, '9' || dbo.PM_F_FORMAT_DATE(getdate(), 'HH24MISS')  || @topup_mobile_no)
