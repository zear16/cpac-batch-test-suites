...
select @trans_no = convert(bigint, dbo.PM_F_FORMAT_DATE(getdate(), 'HH24MISS')  || '3090001')
, @adjust_date = O.DATA_DATE_FR
...
fetch next cur into @topup_mobile_no, @topup_ba_no, @topup_company_id, @topup_company_code
