...
echo -e "inner join PM_PREPAID_LOAD_BATCH B on (R.BATCH_ID = B.BATCH_ID)" >> ${SCRIPT}
echo -e "where B.ORDER_ID = ${ORDER_ID}" >> ${SCRIPT}
echo -e "and R.SEQ_NO = 2" >> ${SCRIPT}
echo -e "and R.FIELD_NAME = 'BILLING_SYSTEM'" >> ${SCRIPT}
echo -e "and R.REMARK = 'Invalid BILLING_SYSTEM'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=2,FIELD_NAME=BILLING_SYSTEM,REMARK=Invalid BILLING_SYSTEM  : ${COUNT}"
...
echo -e "and SUCCESS_AMT = 0" >> ${SCRIPT}
echo -e "and ERROR_AMT = 3.07" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH with BATCH_STATE=C,PROCESS_STATUS=FL,SUCCESS_AMT=0,ERROR_AMT=3.07 : ${COUNT}"
