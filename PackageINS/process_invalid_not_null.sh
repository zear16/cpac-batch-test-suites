...
echo -e "where B.ORDER_ID = ${ORDER_ID} and SEQ_NO = 1 and FIELD_NAME = 'ProductName'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,FIELD_NAME=ProductName : ${COUNT}"
