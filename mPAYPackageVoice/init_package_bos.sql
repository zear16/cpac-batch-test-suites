...
values
(@company_id, @document_type_id, @template_id, 'Unit Test mPAY Package Voice', dateadd(dd, -1, @run_date), 'A', 1
...
VERSION_ID, FILE_NAME, ORIGINAL_FILE_NAME, FILE_PATH
, ZIP_NAME, JOB_CHAIN, ORDER_STATUS)
values
("I", @job_id, @template_code, "A", @run_date, dateadd(dd, -1, @run_date), dateadd(dd, -1, @run_date),
@version_id, "Unit Test mPAY Package Voice", "Unit Test mPAY Package Voice", "/opt/ais/cpac/batchprepaid/package"
, "", @job_chain, "W")
