...
echo -e "and R.FIELD_NAME = 'SEQUENCE NO1'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=2,FIELD_NAME=SEQUENCE NO1 : ${COUNT}"
...
echo -e "where B.ORDER_ID = ${ORDER_ID}" >> ${SCRIPT}
echo -e "and R.SEQ_NO = 2" >> ${SCRIPT}
echo -e "and R.FIELD_NAME = 'PAYMENT DATE'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=2,FIELD_NAME=PAYMENT DATE : ${COUNT}"
