...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with RECONCILE_CODE=004,D_MOBILE_NO=0802001301,TRANS_DTM=20160616,FACE_VALUE=7782 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with RECONCILE_CODE=004,D_MOBILE_NO=0801111111,TRANS_DTM=20160616,FACE_VALUE=100 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
...
echo "      ,REF_1_L_REF_2_RECORD=1,REF_1_L_REF_2_AMT=778200,REF_1_L_REF_2_VALIDITY=0"
