...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with RECONCILE_CODE=001,D_MOBILE_NO=090103319,TRANS_DTM=20160616,FACE_VALUE=7016,VALIDITY=null : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
...
echo -e "and R.REF_2_AMT = 14032" >> ${SCRIPT}
...
echo -e "and R.REF_1_M_REF_2_AMT = 7016" >> ${SCRIPT}
...
echo "      ,REF_2_RECORD=2,REF_2_AMT=14032,REF_2_VALIDITY=0"
echo "      ,REF_1_L_REF_2_RECORD=0,REF_1_L_REF_2_AMT=0,REF_1_L_REF_2_VALIDITY=0"
echo "      ,REF_1_M_REF_2_RECORD=1,REF_1_M_REF_2_AMT=7016,REF_1_M_REF_2_VALIDITY=0 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
