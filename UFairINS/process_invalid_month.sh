...
echo -e "and R.SEQ_NO = 2 and R.REMARK = 'Field StartTime invalid date format (20161622:000000)'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=2,REMARK=Field StartTime invalid date format (20161622:000000) : ${COUNT}"
