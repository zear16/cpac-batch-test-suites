...
echo -e "declare @count int" >> ${SCRIPT}
echo -e "select @count = count(*)" >> ${SCRIPT}
echo -e "from PM_BATCH_UFAIR U"  >> ${SCRIPT}
...
echo -e "and T.MOBILE_NO = '0933516850' and T.ADJUST_AMT = -18.00" >> ${SCRIPT}
echo -e "and T.TRANSPARENT_DATA1 = 'cPAC'" >> ${SCRIPT}
echo -e "and T.TRANSPARENT_DATA2 = 'UFAIR'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_ADJUST_TRANSACTION with MOBILE_NO=0933516850,ADJUST_AMT=-18.00"
echo "      , TRANSPARENT_DATA1=cPAC, TRANSPARENT_DATA2=UFAIR : ${COUNT}"
...
echo -e "\nselect @flag = convert(char(1),FIELD1_VALUE)" >> ${SCRIPT}
...
echo -e "use PMDB\ngo" > ${SCRIPT}
echo -e "\nset nocount on" >> ${SCRIPT}
echo -e "\nupdate PM_SYSTEM_ATTRIBUTE_DTL set FIELD2_VALUE='B'" >> ${SCRIPT}
echo -e "where ATTRIBUTE_CODE = 'PREPAID_PARAM'" >> ${SCRIPT}
echo -e "and DB_VALUE = 'UFAIR_DOC_ADJUST_DEDUCT'" >> ${SCRIPT}
echo -e "\n\ngo" >> ${SCRIPT}
...
echo -e "use PMDB\ngo" > ${SCRIPT}
echo -e "\nset nocount on" >> ${SCRIPT}
echo -e "select A.RECEIPT_ID, A.CN_ID, A.NOTIFICATION_ID" >> ${SCRIPT}
echo -e "from PM_FILE_ADJUST F" >> ${SCRIPT}
echo -e "inner join PM_ADJUST_TRANSACTION A on (F.FILE_ID = A.FILE_ID)" >> ${SCRIPT}
echo -e "where F.ORDER_ID = ${ORDER_ID}" >> ${SCRIPT}
echo -e "\n\ngo" >> ${SCRIPT}
...
echo -e "and A.CN_ID = null" >> ${SCRIPT}
...
echo "found PM_ADJUST_TRANSACTION with ORDER_ID=${ORDER_ID},RECEIPT_ID!=NULL,CN_ID=null,NOTIFICATION_ID!=NULL : ${COUNT}"
