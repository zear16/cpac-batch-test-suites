...
echo -e "and R.SEQ_NO = 2 and R.REMARK = 'Invalid Format (column count mismatch, expected 7 but found 6)'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=2,REMARK=Invalid Format (column count mismatch, expected 7 but found 6) : ${COUNT}"
