...
select @mobile_no = '0801111111'
, @transaction_dtm = '20160616'
, @face_value = 100
, @session_id = 'UNIT_TEST_BILL_TOPUP_SME'

select @recharge_channel = R.SERVICE_ID
from PM_RECHARGE_SERVICE R
where R.BANK_CODE = 517
...
begin
  ...
  , 1, 'Pre-paid', @transaction_dtm, @session_id
  , 10101, '1', '1', 'Y'
