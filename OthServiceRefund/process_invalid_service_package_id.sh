...
echo -e "and TOTAL_AMT = 0.86" >> ${SCRIPT}
echo -e "and SUCCESS_AMT = 0" >> ${SCRIPT}
echo -e "and ERROR_AMT = 0.86" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo -e "      ,TOTAL_AMT=0.86,SUCCESS_AMT=0,ERROR_AMT=0.86 : ${COUNT}"
...
echo -e "and R.FIELD_NAME = 'SERVICE_PACKAGE_ID'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,FIELD_NAME=SERVICE_PACKAGE_ID : ${COUNT}"
