...
values
(@company_id, @document_type_id, @template_id, 'Unit Test ROM Package Voice', dateadd(dd, -1, @run_date), 'A', 1
...
@version_id, "Unit Test ROM Package Voice", "Unit Test ROM Package Voice", "/opt/ais/cpac/batchprepaid/package", "", @job_chain, "W")
