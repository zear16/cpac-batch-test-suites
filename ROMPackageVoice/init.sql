...
select @template_code = 'PE_ROM_PACKAGE_VOICE'
, @run_date = '20160616'
, @file_name = 'VOICE_ROM_20160616.dat'
...
begin
  ...
  ('I', @job_id, @template_code, 'A', @run_date, dateadd(dd, -1, @run_date), dateadd(dd, -1, @run_date)
   , @bank_code, @company_id
   , @version_id, @file_name, @file_name, null, '/opt/ais/cpac/batchprepaid/ROM_PKG_VOICE', 'W')
