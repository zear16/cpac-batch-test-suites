...
select @template_code = 'PE_MPAY_PURCHASE_CWDC1'
, @run_date = '20160616'
, @file_name = 'DailymPAYFlexiPricePaidTransactionService_160616_DCBcwdc1google_160616.dat'
...
begin
  ...
  ('I', @job_id, @template_code, 'A', @run_date, @run_date, @run_date,
   @category_code,
   @version_id, @file_name, @file_name, '/app/payment/batch/mpay_settlement/DATA', 'W')
