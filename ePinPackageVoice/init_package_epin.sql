...
begin
  ...
  insert into PM_PACKAGE
  (PACKAGE_CODE, PACKAGE_NAME, PACKAGE_TYPE, PACKAGE_FEE, BANK_CODE, ACTIVE_BOO, EFFECTIVE_DATE
  , GEN_RECEIPT_BOO
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160001, @package_name, 'D', 100, @bank_code, 'Y', @run_date
  , 'N'
  , 'unit', getdate(), 'unit', getdate())
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160002, @package_name, 'V', 100, @bank_code, 'N', @run_date
  , 'N'
  , 'unit', getdate(), 'unit', getdate())
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (160003, @package_name, 'D', 100, @bank_code, 'N', @run_date
  , 'N'
  , 'unit', getdate(), 'unit', getdate())
