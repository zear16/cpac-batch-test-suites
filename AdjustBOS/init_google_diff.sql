...
values
(@batch_id, '201606161616160000', '0811097495', 100, '003', '5'
, '20160615', '300', 800
...
, RECORD_STATUS, CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
values
(@batch_id, '201606161616160001', '0811097495', 100, '003', '5'
, '20160615', '300', 800
, 'SC', 'unit', '20160615', 'unit', '20160615')

insert into PM_FILE_ADJUST
(ORDER_ID, FILE_NAME, OVER_MAX_BOO, SEND_SMS_BOO, CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
values
(@order_id, 'Unit Test Adjust BOS reconcile with Google', 'N', 'N', 'unit', '20160615', 'unit', '20160615')
