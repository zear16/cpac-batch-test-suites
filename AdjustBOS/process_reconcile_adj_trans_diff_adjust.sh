...
echo -e "and R.REF_1_L_REF_2_RECORD = 2" >> ${SCRIPT}
...
echo "      ,REF_1_RECORD=2,REF_1_AMT=1876,REF_1_VALIDITY=0,REF_2_RECORD=0,REF_2_AMT=0,REF_2_VALIDITY=0"
echo "      ,REF_1_L_REF_2_RECORD=2,REF_1_L_REF_2_AMT=1876,REF_1_L_REF_2_VALIDITY=0"
