...
echo "${EXECUTE_PATH}/reconcile -k -c ${CONFIG_NAME} --order-id ${RECONCILE_ORDER_ID} --reconcile-code 007"
...
echo -e "and R.REF_1_AMT = 938" >> ${SCRIPT}
...
echo -e "and R.REF_1_L_REF_2_AMT = 938" >> ${SCRIPT}
...
echo "      ,REF_1_RECORD=1,REF_1_AMT=938,REF_1_VALIDITY=0"
echo "      ,REF_2_RECORD=0,REF_2_AMT=0,REF_2_VALIDITY=0"
echo "      ,REF_1_L_REF_2_RECORD=1,REF_1_L_REF_2_AMT=938,REF_1_L_REF_2_VALIDITY=0"
...
echo -e "and R.REF_3_AMT = 938" >> ${SCRIPT}
...
COUNT=$(cat ${WORKING_PATH}/count)
echo "found PM_PREPAID_BATCH_RECONCILE with RECONCILE_CODE=008,LAST_BOO=Y,DIFF_BOO=Y : ${COUNT}"
echo "      ,REF_3_RECORD=1,REF_3_AMT=938,REF_3_VALIDITY=0,REF_2_RECORD=0,REF_2_AMT=0,REF_2_VALIDITY=0"
echo "      ,REF_1_RECORD=1,REF_1_AMT=0,REF_1_VALIDITY=0 : ${COUNT}" 
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
