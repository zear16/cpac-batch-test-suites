...
echo "      ,TRANS_DTM=20160615,FACE_VALUE=938,VALIDITY=25 : ${COUNT}"
if [ "$COUNT" -ne "0" ]; then
  exit $RET_FAIL
fi
...
select R.DIFF_BOO, R.LAST_BOO
, R.REF_1_RECORD, R.REF_1_AMT, R.REF_1_VALIDITY
...
echo "      ,REF_1_RECORD=2,REF_1_AMT=938"
echo "      ,REF_2_RECORD=2,REF_2_AMT=938"
echo "      ,REF_1_L_REF_2_RECORD=0,REF_1_L_REF_2_AMT=0"
echo "      ,REF_1_M_REF_2_RECORD=0,REF_1_M_REF_2_AMT=0 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
...
echo "      ,REF_1_RECORD=0,REF_1_AMT=0,REF_1_VALIDITY=0"
echo "      ,REF_2_RECORD=0,REF_2_AMT=0,REF_2_VALIDITY=0"
echo "      ,REF_3_RECORD=2,REF_3_AMT=1876,REF_3_VALIDITY=0 : ${COUNT}"
if [ "$COUNT" -ne "1" ]; then
  exit $RET_FAIL
fi
