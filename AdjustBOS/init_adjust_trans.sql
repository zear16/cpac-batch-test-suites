...
select @so_nbr = 'Unit Test Adjust BOS Reconcile Amount'
...
begin
  ...
  values
  (@so_nbr, '0811097495', 938, null, 'SC', 'BOS'
  , '20160615'
...
select @so_nbr = 'Unit Test Adjust BOS Reconcile Validity'
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (@so_nbr, '0811097495', null, 25, 'SC', 'BOS'
  , '20160615'
  , 'unit', '20160615', 'unit', '20160615')
...
begin
  ...
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (@so_nbr, '0811097495', 938, 25, 'SC', 'BOS'
  , '20160615'
  , 'unit', '20160615', 'unit', '20160615')
