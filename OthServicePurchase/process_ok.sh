...
echo -e "and L.TOTAL_AMT = 9.83" >> ${SCRIPT}
echo -e "and L.SUCCESS_AMT = 9.83" >> ${SCRIPT}
echo -e "and L.ERROR_AMT = 0" >> ${SCRIPT}
echo -e "\nprint '%1!', @count\n\ngo" >> ${SCRIPT}
...
echo "found PM_BATCH_DCB with RECORD_STATUS=SC,TOTAL_AMT=9.83,SUCCESS_AMT=9.83,ERROR_AMT=0 : ${COUNT}"
