...
declare @paper_size_name varchar(200)
...
begin
  ...
  (TEMPLATE_NAME, TEMPLATE_VERSION, PAPER_SIZE_ID, ACTIVE_BOO, LANGUAGE_ID
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  ('Template Unit Test', '1.0', @paper_size_id, 'Y', @language_id
  , 'unit', getdate(), 'unit', getdate())
