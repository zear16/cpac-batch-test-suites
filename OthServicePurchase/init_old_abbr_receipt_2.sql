...
select @mobile_no = '0854000673', @total_bal = 2
, @paper_size_name = 'Z'
...
select @paper_size_id = PAPER_SIZE_ID
from PM_PAPER_SIZE where PAPER_SIZE_NAME = @paper_size_name
if (@@rowcount = 0)
begin
  ...
  values
  (@paper_size_name, 100, 200, '20160616', 'Y'
...
right(replicate('0',2)+convert(varchar(2),@mm),2) || '-0000000018'
...
print '@receipt_no=[%1!],@receipt_date=[%2!],@document_type_id=[%3!],@bop_id=[%4!]'
, @receipt_no, @receipt_date, @document_type_id, @bop_id
