...
create table #SFF_TEMP_ORDER (
  ID            unsigned bigint identity,
  ROW_ID        varchar(50)     not null,
  POST_ACCNT_ID varchar(50)     not null,
  PRE_ACCNT_ID  varchar(50)     null,
  MOBILE_NO     varchar(30)     null,
  STATUS_CD     varchar(30)     not null
)

create table #SFF_ACCOUNT_PRE (
  ID            unsigned bigint identity,
...
and BA.BILLING_SYSTEM = 'BOS'
and BA.ACCNT_NO like '20170127%'
and AI.MOBILE_NO = '0801010000'
