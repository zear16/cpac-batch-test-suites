...
values
(@company_id, @document_type_id, @template_id, 'Unit Test ePin Package Data'
...
@version_id, "Unit Test ePin Package Data", "Unit Test ePin Package Data", "/opt/ais/cpac/batchprepaid/package", "", @job_chain, "W")
