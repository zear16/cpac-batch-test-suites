...
select @template_code = 'PE_EPIN_PACKAGE_DATA'
, @run_date = '20160616'
, @file_name = 'DATA_EPINPACK_BOS_20160616.dat'

select @bank_code = BANK_CODE from PM_BANK where BANK_ABBR = 'EPIN'

select @category_code = CATEGORY_CODE from PM_PAYMENT_CATEGORY where CATEGORY_ABBR = 'EP'
