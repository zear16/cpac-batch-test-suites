...
, @sync_name = 'ABC_TRAN_PPS_AWN_20160616.sync'
...
begin
  ...
  , VERSION_ID, FILE_NAME, ORIGINAL_FILE_NAME, FILE_PATH, ORDER_STATUS, BILLING_SYSTEM
  , SOURCE_CTRL_PATH, SOURCE_CTRL_NAME)
  values
  ('I', @job_id, @template_code, 'A', @run_date, dateadd(dd, -1, @run_date), dateadd(dd, -1, @run_date),
  @version_id, @file_name, @file_name, '/app/payment/batch/ins/adjust/20160616', 'W', 'INS'
  , '/app/payment/batch/ins/adjust/20160616', @sync_name)
