...
select @run_date = '20160615'

select @job_id = JOB_ID, @job_chain = JOB_CHAIN from PM_JOB_SCHEDULER_MAPPING where TEMPLATE_CODE = "PE_Oth_Serv_Refund"
...
where C.TEMPLATE_CODE = "PE_Oth_Serv_Refund"
...
values
("I", @job_id, "PE_Oth_Serv_Refund", "A", @run_date, @run_date, @run_date,
