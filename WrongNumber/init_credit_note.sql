...
, CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
values
(@company_id, @document_type_id, @template_id, 'ForUnitTestWrongNumber', @trans_date, 'BA'
...
update PM_ADJUST_TRANSACTION set CN_ID = @cn_id
, CN_DATE = @trans_date
where SO_NBR = 'Unit Test Adjust Wrong Number'
