...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with RECONCILE_CODE=026,S_MOBILE_NO=0817053436"
echo "      ,D_MOBILE_NO=0811097495,TRANS_DTM=20160615,FACE_VALUE=16,VALIDITY=null : ${COUNT}"
if [ "$COUNT" -ne "2" ]; then
  exit $RET_FAIL
fi
