...
echo -e "and R.SEQ_NO = 1 and R.REMARK = 'Invalid Format (column count mismatch, expected 5 but found 4)'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,REMARK=Invalid Format (column count mismatch, expected 5 but found 4) : ${COUNT}"
