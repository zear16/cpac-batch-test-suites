...
echo -e "and R.SEQ_NO = 1 and R.REMARK = 'Field Receipt Date invalid date format (20160631)'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,REMARK=Field Receipt Date invalid date format (20160631) : ${COUNT}"
