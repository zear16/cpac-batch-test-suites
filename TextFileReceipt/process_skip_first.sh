...
echo -e "where ORDER_ID = ${ORDER_ID} and LOAD_TOTAL = 0 and LOAD_SUCCESS = 0 and LOAD_ERROR = 0" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH with LOAD_TOTAL=0,LOAD_SUCCESS=0,LOAD_ERROR=0 : ${COUNT}"
