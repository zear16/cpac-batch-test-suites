...
select @template_code = 'PE_TEXT_FILE_RECEIPT'
, @run_date = '20160616'
, @file_name = 'Adjust_receipt_20160616.txt'
, @loop = 1
...
begin
  ...
  begin
    ...
    delete PM_BATCH_PP_RECEIPT
    from PM_BATCH_PP_RECEIPT B
    inner join PM_PREPAID_LOAD_BATCH L on (B.BATCH_ID = L.BATCH_ID)
    where L.ORDER_ID = @order_id

    delete PM_INF_BATCH_PP_RECEIPT
    from PM_INF_BATCH_PP_RECEIPT I
