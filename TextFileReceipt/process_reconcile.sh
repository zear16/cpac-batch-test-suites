...
echo -e "and R.REF_2_AMT = 66.68" >> ${SCRIPT}
...
echo "found PM_PREPAID_BATCH_RECONCILE with RECONCILE_CODE=013,LAST_BOO=Y,DIFF_BOO=N"
echo "      ,REF_1_RECORD=1,REF_1_AMT=66.68,REF_1_VALIDITY=0"
echo "      ,REF_2_RECORD=1,REF_2_AMT=66.68,REF_2_VALIDITY=0"
