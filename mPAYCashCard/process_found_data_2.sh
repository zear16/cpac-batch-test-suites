...
echo -e "D|10016|20160614000000|20160614000000|999999999999999|99999999999999999999|0||9999999999|1|200|Y|S|200||" >> ${SCRIPT} >> ${WORKING_PATH}/compare
echo -e "D|10016|20160614000000|20160614000000|999999999999999|99999999999999999999|0||9999999999|1|300|N|T|300||" >> ${SCRIPT} >> ${WORKING_PATH}/compare
echo -e "T|20160614000000|2|2|500" >> ${WORKING_PATH}/compare

DIFF=$(diff ${EXPORT_PATH}/${EXPORT_DATA_FILE} ${WORKING_PATH}/compare)
if [ "${DIFF}" != "" ]; then
  echo "=== actual ==="
  cat ${EXPORT_PATH}/${EXPORT_DATA_FILE}
  echo "=== expected ==="
  cat ${WORKING_PATH}/compare
  echo "${DIFF}"
  exit $RET_FAIL
fi
