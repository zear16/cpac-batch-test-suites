...
select @bos_id = BOS_ID from PM_CFG_BOS_SITE where FILE_TYPE = 'PE_RECHARGE' and BOS_SITE_CODE = 'bos1'
...
begin
  ...
  , VERSION_ID, FILE_NAME, ORIGINAL_FILE_NAME
  , FILE_PATH, ORDER_STATUS, BOS_ID
  , SOURCE_CTRL_PATH, SOURCE_CTRL_NAME
  , BILLING_SYSTEM)
  values
  ('I', @job_id, 'PE_RECHARGE', 'A', @run_date, @run_date, @run_date
  , @version_id, @file_name, @file_name
  , '/app/payment/batch/bos1/Report/20160616', 'W', @bos_id
