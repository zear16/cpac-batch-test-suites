...
select @sub_bop_id = SUB_BOP_ID from PM_SUB_BUSINESS_OF_PAYMENT where SUB_BOP_CODE = 'DV'
...
, @period, 18, 'N', @location_code, @mobile_no, @receipt_id out, @doc_no out

exec _INSERT_RECEIPT @trans_date, @company_id, @company_code, @bop_id, @bop_code
, @doc_type_id, @doc_type, @channel_id, @channel_code, @category_code, @bank_code
, @period, 16, 'N', @location_code, @mobile_no, @receipt_id out, @doc_no out
