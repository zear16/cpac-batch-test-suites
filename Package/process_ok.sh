...
echo -e "\ngo" >> ${SCRIPT}
echo -e "set nocount on" >> ${SCRIPT}
echo -e "select BATCH_STATE, PROCESS_STATUS, LOAD_TOTAL, LOAD_SUCCESS, LOAD_ERROR, TOTAL_AMT, SUCCESS_AMT, ERROR_AMT" >> ${SCRIPT}
echo -e "from PM_PREPAID_LOAD_BATCH"  >> ${SCRIPT}
...
echo -e "and LOAD_TOTAL = 1 and LOAD_SUCCESS = 1 and LOAD_ERROR = 0" >> ${SCRIPT}
echo -e "and TOTAL_AMT = 18.0" >> ${SCRIPT}
echo -e "and SUCCESS_AMT = 18.0" >> ${SCRIPT}
...
echo -e "                                 ,LOAD_TOTAL=1,LOAD_SUCCESS=1,LOAD_ERROR=0"
echo -e "                                 ,TOTAL_AMT=18.0,SUCCESS_AMT=18.0,ERROR_AMT=0 : ${COUNT}"
...
echo -e "where B.ORDER_ID = ${ORDER_ID}" >> ${SCRIPT}
echo -e "and P.BILLING_SYSTEM = 'BOS'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count\n\ngo" >> ${SCRIPT}
...
echo "found PM_PACKAGE_BOS with BILLING_SYSTEM='BOS' : ${COUNT}"
