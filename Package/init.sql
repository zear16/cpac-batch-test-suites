...
select @template_code = 'PE_PACKAGE_BOS', @run_date = '20160616'
, @file_name = 'PAL_TRAN_PPS_AWN_20160805135742_20160805185742.rpt'
, @sync_name = 'PAL_TRAN_PPS_AWN_20160805135742_20160805185742.sync'
...
begin
  ...
  , @version_id, @file_name, @file_name, '/app/payment/batch/bos1/EXT_INTERFACE/SEND_FILE/BL_PPP_001', 'W'
  , 'BOS', @bos_id, '/app/payment/batch/bos1/EXT_INTERFACE/SEND_FILE/BL_PPP_001', @sync_name)
