...
echo "found PM_PREPAID_BATCH_RECONCILE_DIFF with RECONCILE_CODE=025 : ${COUNT}"
if [ "$COUNT" -ne "0" ]; then
  exit $RET_FAIL
fi
...
echo -e "and R.REF_2_AMT = 18" >> ${SCRIPT}
...
echo "      ,REF_2_RECORD=1,REF_2_AMT=18,REF_2_VALIDITY=0"
