...
select @so_nbr = 'Unit Test Text File CN Reconcile Success'
...
begin
  ...
  , ADJUST_DTM, ADJUST_DATE, CN_NO, BILLING_SYSTEM
  , GEN_CN_BOO
  , CREATED_BY, CREATED, LAST_UPD_BY, LAST_UPD)
  values
  (@so_nbr, '0892500816', -39.94, null, 'SC'
  , '20160615', '20160615', 'N6-1609-1559-0000000000', 'RTBS'
  , 'Y'
