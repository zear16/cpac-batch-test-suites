...
echo -e "and R.SEQ_NO = 1 and R.REMARK = 'Field DN/CN Date invalid date format (2016061)'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,REMARK=Field DN/CN Date invalid date format (2016061) : ${COUNT}"
