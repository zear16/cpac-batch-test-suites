...
select @template_code = 'PE_UFAIR_BOS'
, @run_date = '20160616'
, @file_name = 'BOSUFAIR_20160616_161616_001.csv'
, @loop = 1
...
begin
  ...
  begin
    ...
    inner join PM_ADJUST_TRANSACTION A on (AC.ADJUST_ID = A.ADJUST_ID)
    inner join PM_FILE_ADJUST AF on (A.FILE_ID = AF.FILE_ID)
    where AF.ORDER_ID = @order_id
