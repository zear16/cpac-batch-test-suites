...
echo -e "and R.SEQ_NO = 1 and R.REMARK = 'Field Product Valid Date invalid date format (16062016 161616)'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,REMARK=Field Product Valid Date invalid date format (16062016 161616) : ${COUNT}"
