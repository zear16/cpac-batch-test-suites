...
echo -e "and R.SEQ_NO = 1 and R.FIELD_NAME = 'VALID_DTM' and R.REMARK = 'Invalid VALID_DTM'" >> ${SCRIPT}
echo -e "\nprint '%1!', @count" >> ${SCRIPT}
echo -e "\ngo" >> ${SCRIPT}
...
echo "found PM_PREPAID_LOAD_BATCH_REJECT with SEQ_NO=1,FIELD_NAME=VALID_DTM,REMARK=Invalid VALID_DTM : ${COUNT}"
