...
select @template_code = 'PE_UFAIR_BOS', @run_date = '20160616'
, @file_name = 'BOSUFAIR_20160616_161616_001.csv'
, @sync_name = 'BOSUFAIR_20160616_161616_001.sync'
...
begin
  ...
  , @version_id, @file_name, @file_name, '/app/payment/batch/ufair_bos', 'W'
  , '/app/payment/batch/ufair_bos', @sync_name, 'BOS')
